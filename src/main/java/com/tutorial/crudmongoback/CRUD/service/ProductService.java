...
public class ProductService {
    ...
    public Product getOne(int id) throws ResourceNotFoundExceptions {
        return productRepository.findById(id).orElseThrow( ()-> new ResourceNotFoundExceptions("not found"));
    }
    ...
    public Product update(int id, ProductDto dto) throws ResourceNotFoundExceptions, AttributeException {
        Product product = productRepository.findById(id).orElseThrow( ()-> new ResourceNotFoundExceptions("not found"));
