...
public class GlobalException {
    ...
    public ResponseEntity <MessageDto> throwNotFoundException(ResourceNotFoundExceptions e){
    ...
    public ResponseEntity <MessageDto> validationException(MethodArgumentNotValidException e){
        ...
        return ResponseEntity.badRequest()
                .body(new MessageDto(HttpStatus.BAD_REQUEST, Operations.trimBreackets(messages.toString())));
